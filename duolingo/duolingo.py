...
from duolingo.response_types import StreakInfo, LanguageDetails, UserDetails, LanguageProgress, FriendInfo, WordInfo
...
class Duolingo(object):
    ...
    def __init__(self, username: str, *, jwt: str = None):
        """
